...
class cb_static_meta_box {
	...
	public function display_meta_box( $post ) {
		...
		<input type="hidden" name="cb-static-background-image" id="cb-static-background-image" value="<?php echo esc_attr( $attachment_id ); ?>"/>
		<!-- End hidden fields. -->

		<!-- Begin background color. -->
		<p>
			<label for="cb-static-background-color"><?php _e( 'Background Color', $this->plugin_domain ); ?></label>
			<input type="text" name="cb-static-background-color" id="cb-static-backround-color" class="cb-static-wp-color-picker"
		...
		<p>
			...
			<a href="#" class="cb-static-add-media cb-static-add-media-text"><?php _e( 'Set background image', $this->plugin_domain ); ?></a>
		...
		<div class="cb-static-background-image-options">
			...
			<p>
				<label for="cb-static-background-position-x"><?php _e( 'Horizontal Position', $this->plugin_domain ); ?></label>
				...
				<p>
					<label for="cb-static-background-position-y"><?php _e( 'Vertical Position', $this->plugin_domain ); ?></label>
	...
	public function save_post( $post_id, $post ) {
		...
		if ( 0 >= $image_id ) {
			...
			$repeat     = in_array( $_POST['cb-static-background-repeat'], $allowed_repeat ) ? $_POST['cb-static-background-repeat'] : '';
			$position_x = in_array( $_POST['cb-static-background-position-x'], $allowed_position_x ) ? $_POST['cb-static-background-position-x'] : '';
			$position_y = in_array( $_POST['cb-static-background-position-y'], $allowed_position_y ) ? $_POST['cb-static-background-position-y'] : '';
			$attachment = in_array( $_POST['cb-static-background-attachment'], $allowed_attachment ) ? $_POST['cb-static-background-attachment'] : '';
		}
